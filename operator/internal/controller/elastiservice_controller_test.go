...
var _ = Describe("ElastiService Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ElastiService")
			err := k8sClient.Get(ctx, typeNamespacedName, elastiservice)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ElastiService")
